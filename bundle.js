...
var _user$project$Main$editStyle = function (b) {
	return _elm_lang$core$Native_Utils.eq(b, true) ? _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
...
var _user$project$Main$edit = F2(
	function (model, id) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: newPlayers, plays: newPlays, name: '', playerId: _elm_lang$core$Maybe$Nothing, editing: false});
	});
var _user$project$Main$delete = F2(
	function (model, shot) {
		var newplays = A2(
			...
			function (p) {
				return !_elm_lang$core$Native_Utils.eq(p.id, shot.id);
			},
			model.plays);
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.id, shot.playerId) ? _elm_lang$core$Native_Utils.update(
					player,
					{points: player.points - shot.points}) : player;
			},
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Main$add = function (model) {
	...
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			players: {ctor: '::', _0: newPlayer, _1: model.players},
			name: ''
		});
};
		...
		var newPlayers = A2(
			...
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.id, scorer.id) ? _elm_lang$core$Native_Utils.update(
					player,
					{points: player.points + pts}) : player;
			},
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			default:
				return A2(_user$project$Main$delete, model, _p1._0);
		}
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {players: a, name: b, playerId: c, plays: d, editing: e};
	});
var _user$project$Main$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$Main$play = function (shot) {
	return A2(
		...
		{ctor: '[]'},
		{
				...
				_elm_lang$html$Html$i,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$Delete(shot)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(shot.name),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(shot.points)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Main$editStyle(model.editing),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$editStyle(false),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$pointsTotal(model),
					_1: {ctor: '[]'}
				}
			}
		});
